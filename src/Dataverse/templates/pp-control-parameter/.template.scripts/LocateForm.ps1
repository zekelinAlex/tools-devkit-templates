...
elseif ($formId -eq "{unknownFormId}") {
    $formDirectory = './__solution-declarations-root__/Entities/__entity-schema-name__/FormXml/__form-type__/'
    ...
    if('__form-type__' -eq 'dialog') 
    {
        ...
        $entityXmlPath = (Resolve-Path './__solution-declarations-root__/Entities/__entity-schema-name__/FormXml/__form-type__/{__form-id__}.xml').Path
    }
}
